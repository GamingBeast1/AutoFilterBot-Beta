...
# Channels
INDEX_CHANNELS = [int(index_channels) if index_channels.startswith("-") else index_channels for index_channels in environ.get('INDEX_CHANNELS', '-1001803596059').split()]
...
# Links
SUPPORT_LINK = environ.get('SUPPORT_LINK', 'https://t.me/MOVIESGALAXY01')
UPDATES_LINK = environ.get('UPDATES_LINK', 'https://t.me/MOVIESGALAXY01')
